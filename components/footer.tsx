...
const Footer = () => {
  return <><div className={styles.container}>
    <section className={styles.newsletter}>
      ...
      <p className={styles.consent}>By clicking “Sign up” you agree with our <span>terms and Conditions</span>.</p>
      <button type="submit" className={styles.cta} >{BUTTONS.signUp}</button>
      </form>
    </section>
    ...
    <section className={styles.legal}>
      ...
      <div className={styles.separator}></div>
      <p>{FOOTER.legalCookies}</p></section></div></>;
};
